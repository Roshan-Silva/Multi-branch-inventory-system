        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GoodsReceivedNotes_Users_ConfirmedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GoodsReceivedItems_GoodsReceivedNotes_GoodsReceivedNoteId",
                        column: x => x.GoodsReceivedNoteId,
                        principalTable: "GoodsReceivedNotes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GoodsReceivedItems_PurchaseOrderItems_PurchaseOrderItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GoodsReceivedItems_GoodsReceivedNoteId_PurchaseOrderItemId",
                table: "GoodsReceivedItems",
                columns: new[] { "GoodsReceivedNoteId", "PurchaseOrderItemId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_GoodsReceivedItems_PurchaseOrderItemId",
                table: "GoodsReceivedItems",
                column: "PurchaseOrderItemId");

            migrationBuilder.CreateIndex(
                name: "IX_GoodsReceivedNotes_ConfirmedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseOrderItems_PurchaseOrderId_PurchaseRequestItemId",
                table: "PurchaseOrderItems",
                columns: new[] { "PurchaseOrderId", "PurchaseRequestItemId" },
                unique: true);
